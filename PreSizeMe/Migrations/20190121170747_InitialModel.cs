...
namespace PreSizeMe.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sleeve = table.Column<int>(nullable: false),
                    Upperbody = table.Column<int>(nullable: false),
                    Chest = table.Column<int>(nullable: false),
                    BelowChest = table.Column<int>(nullable: false),
                    Waist = table.Column<int>(nullable: false),
                    Hips = table.Column<int>(nullable: false),
                    Thigh = table.Column<int>(nullable: false),
                    Inseam = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurement_Gender_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Measurement_MeasurementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MeasurementId",
                table: "AspNetUsers",
