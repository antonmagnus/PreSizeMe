...
namespace PreSizeMe.Migrations
{
    ...
    [Migration("20190131075250_OpenIdicct")]
    partial class OpenIdicct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PreSizeMe.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PreSizeMe.Data.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PreSizeMe.Data.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("BelowChest");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PreSizeMe.Data.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PreSizeMe.Data.ApplicationUser", b =>
                {
                    b.HasOne("PreSizeMe.Data.Measurement", "Measurement")
                        .WithMany()
            ...
            modelBuilder.Entity("PreSizeMe.Data.Measurement", b =>
                {
                    b.HasOne("PreSizeMe.Data.Gender", "Gender")
                        .WithMany()
